...
\begin{figure}[h]
    \begin{tikzpicture}[yscale=0.9,xscale=0.9]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Loss of RPS-LS networks over number of iterations: blue for DeepProbLog, red for CNN, green for the novel CNN with a learning rate of 0.002}
...
\begin{figure}[h]
    \begin{tikzpicture}[yscale=0.9,xscale=0.9]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Accuracy of RPS-LS networks over number of iterations: blue for DeepProbLog, red for CNN, green for the novel CNN with a learning rate of 0.002}
